    ...
    return AuthUserStreamWidget(
      builder: (context) => StreamBuilder<List<IllnessesRecord>>(
        ...
        builder: (context, snapshot) {
          ...
          List<IllnessesRecord> saladIllnessesRecordList = snapshot.data!;
          // Return an empty Container when the item does not exist.
          if (snapshot.data!.isEmpty) {
            return Container();
          }
          final saladIllnessesRecord = saladIllnessesRecordList.isNotEmpty
              ? saladIllnessesRecordList.first
              : null;
