  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<UserNutrientContentRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UserNutrientContentRecord> beveragesUserNutrientContentRecordList =
            snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final beveragesUserNutrientContentRecord =
            beveragesUserNutrientContentRecordList.isNotEmpty
                ? beveragesUserNutrientContentRecordList.first
                : null;
              ...
              stream: queryIntoleranceListRecord(
                queryBuilder: (intoleranceListRecord) =>
                    intoleranceListRecord.whereIn(
                        'intolerance',
                        beveragesUserNutrientContentRecord!.intolerances!
                            .toList()),
                singleRecord: true,
              ),
              builder: (context, snapshot) {
