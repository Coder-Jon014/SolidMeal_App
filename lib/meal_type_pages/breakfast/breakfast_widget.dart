  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<UserNutrientContentRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UserNutrientContentRecord> breakfastUserNutrientContentRecordList =
            snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final breakfastUserNutrientContentRecord =
            breakfastUserNutrientContentRecordList.isNotEmpty
                ? breakfastUserNutrientContentRecordList.first
                : null;
              ...
              stream: queryIntoleranceListRecord(
                queryBuilder: (intoleranceListRecord) =>
                    intoleranceListRecord.whereIn(
                        'intolerance',
                        breakfastUserNutrientContentRecord!.intolerances!
                            .toList()),
                singleRecord: true,
              ),
              builder: (context, snapshot) {
