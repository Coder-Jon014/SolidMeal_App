...
class BeveragesWidget extends StatefulWidget {
  ...
  @override
  _BeveragesWidgetState createState() => _BeveragesWidgetState();
}
    ...
    return AuthUserStreamWidget(
      builder: (context) => StreamBuilder<List<IllnessesRecord>>(
        ...
        builder: (context, snapshot) {
          ...
          List<IllnessesRecord> beveragesIllnessesRecordList = snapshot.data!;
          // Return an empty Container when the item does not exist.
          if (snapshot.data!.isEmpty) {
            return Container();
          }
          final beveragesIllnessesRecord =
              beveragesIllnessesRecordList.isNotEmpty
                  ? beveragesIllnessesRecordList.first
                  : null;
                        ...
                        Padding(
                          ...
                          child: FutureBuilder<ApiCallResponse>(
                            future: RecipesCall.call(
                              ...
                              type: 'beverage',
                              minSugar:
                                  columnUserNutrientContentRecord!.minSugar,
                              minPotassium:
                                  columnUserNutrientContentRecord!.minPotassium,
                              minFiber:
                                  columnUserNutrientContentRecord!.minFiber,
                              limitLicense: true,
                              instructionsRequired: true,
                              addRecipeInformation: true,
                              minProtein:
                                  columnUserNutrientContentRecord!.minProtein,
                              sort: 'popularity',
                            ),
                            builder: (context, snapshot) {
                              // Customize what your widget looks like when it's loading.
