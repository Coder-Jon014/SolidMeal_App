              ...
              stream: queryIntoleranceListRecord(
                queryBuilder: (intoleranceListRecord) =>
                    intoleranceListRecord.whereIn('intolerance',
                        homeUserNutrientContentRecord!.intolerances!.toList()),
                singleRecord: true,
              ),
              builder: (context, snapshot) {
                // Customize what your widget looks like when it's loading.
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  final knnRecipes =
                                    ...
                                    homeUserNutrientContentRecord!
                                        .maxMagnesium!,
                                    recipes,
                                    homeUserNutrientContentRecord!.intolerancesKeyWords!.toList(),
                                  );
                                    ...
                                    builder: (context) {
                                      return Wrap(
                                        ...
                                        children: List.generate(
                                            knnRecipes.length, (recipeIndex) {
                                          final recipeItem =
                                              knnRecipes[recipeIndex];
                                          return Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    0.0, 0.0, 0.0, 10.0),
