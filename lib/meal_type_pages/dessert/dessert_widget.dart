  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<UserNutrientContentRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UserNutrientContentRecord> dessertUserNutrientContentRecordList =
            snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final dessertUserNutrientContentRecord =
            dessertUserNutrientContentRecordList.isNotEmpty
                ? dessertUserNutrientContentRecordList.first
                : null;
              ...
              stream: queryIntoleranceListRecord(
                queryBuilder: (intoleranceListRecord) =>
                    intoleranceListRecord.whereIn(
                        'intolerance',
                        dessertUserNutrientContentRecord!.intolerances!
                            .toList()),
                singleRecord: true,
              ),
              builder: (context, snapshot) {
