    ...
    return AuthUserStreamWidget(
      builder: (context) => StreamBuilder<List<IllnessesRecord>>(
        ...
        builder: (context, snapshot) {
          ...
          List<IllnessesRecord> breakfastIllnessesRecordList = snapshot.data!;
          // Return an empty Container when the item does not exist.
          if (snapshot.data!.isEmpty) {
            return Container();
          }
          final breakfastIllnessesRecord =
              breakfastIllnessesRecordList.isNotEmpty
                  ? breakfastIllnessesRecordList.first
                  : null;
