                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      ...
                      onChanged: (_) => EasyDebounce.debounce(
                        ...
                        () async {
                          setState(() {
                            FFAppState().queryBeverage = valueOrDefault<String>(
                  ...
                  Padding(
                    ...
                    child: FutureBuilder<ApiCallResponse>(
                      future: RecipesCall.call(
                        ...
                        offset: 1,
                        type: 'beverage',
                        minSugar: columnUserNutrientContentRecord!.minSugar,
                        minPotassium:
                            columnUserNutrientContentRecord!.minPotassium,
                        minFiber: columnUserNutrientContentRecord!.minFiber,
                        limitLicense: true,
                        instructionsRequired: true,
                        addRecipeInformation: true,
                        minProtein: columnUserNutrientContentRecord!.minProtein,
                        sort: 'popularity',
                      ),
                      builder: (context, snapshot) {
                        // Customize what your widget looks like when it's loading.
