...
import 'get_to_know2_model.dart';
export 'get_to_know2_model.dart';

class GetToKnow2Widget extends StatefulWidget {
  const GetToKnow2Widget({Key? key}) : super(key: key);

  @override
  _GetToKnow2WidgetState createState() => _GetToKnow2WidgetState();
}

class _GetToKnow2WidgetState extends State<GetToKnow2Widget>
    with TickerProviderStateMixin {
  late GetToKnow2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GetToKnow2Model());
  }
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<UsersRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final getToKnow2UsersRecord = snapshot.data!;
