...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'GetToKnow1',
          path: '/getToKnow1',
          builder: (context, params) => GetToKnow1Widget(),
        ),
        FFRoute(
          name: 'Login',
          path: '/login',
        ...
        FFRoute(
          name: 'GetToKnow2',
          path: '/getToKnow2',
          builder: (context, params) => GetToKnow2Widget(),
        ),
        FFRoute(
          name: 'GetToKnow3',
          path: '/getToKnow3',
          builder: (context, params) => GetToKnow3Widget(),
        ),
        FFRoute(
          name: 'onboarding3',
          path: '/onboarding3',
        ...
        FFRoute(
          name: 'DietPage',
          path: '/dietPage',
          builder: (context, params) => DietPageWidget(),
        ),
        FFRoute(
          name: 'IntolerancesPage',
          path: '/intolerancesPage',
          builder: (context, params) => IntolerancesPageWidget(),
        ),
        FFRoute(
          name: 'NutrientContentPage',
          path: '/nutrientContentPage',
          builder: (context, params) => NutrientContentPageWidget(),
        ),
        FFRoute(
          name: 'RecipeNutrientContentPage',
          path: '/recipeNutrientContentPage',
          builder: (context, params) => RecipeNutrientContentPageWidget(
