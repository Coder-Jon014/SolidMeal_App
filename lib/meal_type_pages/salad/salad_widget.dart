  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<UserNutrientContentRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UserNutrientContentRecord> saladUserNutrientContentRecordList =
            snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final saladUserNutrientContentRecord =
            saladUserNutrientContentRecordList.isNotEmpty
                ? saladUserNutrientContentRecordList.first
                : null;
            ...
            body: StreamBuilder<List<IntoleranceListRecord>>(
              stream: queryIntoleranceListRecord(
                queryBuilder: (intoleranceListRecord) =>
                    intoleranceListRecord.whereIn('intolerance',
                        saladUserNutrientContentRecord!.intolerances!.toList()),
                singleRecord: true,
              ),
              builder: (context, snapshot) {
                // Customize what your widget looks like when it's loading.
